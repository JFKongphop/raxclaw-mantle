...
Next.js frontend for the RAXC autonomous smart contract vulnerability scanner — powered by Qdrant RAG + OpenAI, with on-chain encrypted audit proofs on Mantle Sepolia.

## Features

- 🔍 **Live Audit Terminal** — Paste any Solidity contract and run the 13-phase analysis pipeline via WebSocket
- 🧠 **Cognition History** — All past audits displayed with on-chain proof links
- 🔒 **Encrypted Reports** — ECIES + AES-256-GCM encrypted audit reports, owner-only readable
- 📊 **Real-time Stats** — Live on-chain metrics from Mantle Sepolia
- 🔗 **Mantle Sepolia** — ERC-8004 agent contract for identity + reputation
