      ...
      <div className="section-inner">
        <div style={{ marginBottom: 52 }}>
          ...
          <p className="section-desc">
            Every audit is permanently stored on-chain via Mantle Sepolia.
        ...
        >
          ...
          <span style={{ color: 'var(--cyan)' }}>Mantle Sepolia</span> and anchored
          via ERC-7857 on{' '}
          <span style={{ color: 'var(--cyan)' }}>Mantle Mainnet (chain 5000)</span>.
