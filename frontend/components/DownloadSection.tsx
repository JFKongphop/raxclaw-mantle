const PLATFORMS = [
  {
    ...
    cmd: 'git clone https://github.com/JFKongphop/raxclaw-mantle',
    alt: 'cd raxclaw-mantle',
    icon: '📦',
  },
  {
    os: 'Build',
    ...
    <section className="section" id="download">
      <div className="section-inner">
        ...
        >
          ...
          {[
            { prompt: '$ ', code: 'git clone https://github.com/JFKongphop/raxclaw-mantle', color: 'var(--text-muted)' },
            { prompt: '$ ', code: 'cd raxclaw-mantle && pnpm install', color: 'var(--text-muted)' },
        ...
        >
          ...
          >
            ...
            ./dist/raxclaw run <span style={{ color: '#999999' }}>&quot;&lt;contract code&gt;&quot;</span>
          </div>
...
{[
  ...
  return <span key={i} style={{ color: '#64748b' }}>{line.v}{line.rest ?? ''}{'\n'}</span>;
        ...
        >
          <a
            href="https://github.com/JFKongphop/raxclaw-mantle"
          ...
          <a
            href="https://github.com/JFKongphop/raxclaw-mantle/blob/main/README.md"
