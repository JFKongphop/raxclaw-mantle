      ...
      <div className="section-inner">
        <div style={{ marginBottom: 52 }}>
          ...
          <p className="section-desc">
            Live audit records from RaxcAgentERC8004 on Mantle Sepolia. 
            <br />
        ...
        {loading && (
          <div style={{ fontFamily: 'var(--font-mono)', fontSize: 12, color: 'var(--text-dim)', padding: '40px 0' }}>
            Fetching audit tasks from Mantle Sepolia…
          </div>
        )}
          ...
          {audits.map((audit) => (
            (
              <div
                ...
                onClick={() => router.push(`/tx-report/${audit.txHash}`)}
              >
                {/* Left accent bar */}
